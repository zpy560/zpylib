...
ros2_control 的硬件抽象与控制器管理框架已补充至 `notes/2026-06-24-ros2-control-hardware-controller-framework.md`。它可作为 ROS 2 执行层接口资源管理参考，但不替代 Autoware 的命令门控、MRM、车辆接口和安全检查链。
