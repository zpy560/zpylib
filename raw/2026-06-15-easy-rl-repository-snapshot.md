...
> 本文件保存 2026-06-15 抓取到的仓库事实与 `docs/README.md` 原文。分析与判断见对应的 `notes/` 和 `wiki/` 文件。
...
- 抓取分支：`master`
- 抓取提交：`6b7df8451f74f16d5efb6abc1b94a8746890a0ad`
- 抓取日期：2026-06-15
- 仓库默认语言：Jupyter Notebook
- 许可证：CC BY-NC-SA 4.0
- 仓库结构：540 个 Git tree 条目；34 个 `docs/` Markdown 文件；16 个 Notebook；19 个参考论文 PDF

## 主要目录

- `docs/`：16 章教程、配套习题、3 个实践项目和勘误。
- `notebooks/`：值迭代、Q-learning、Sarsa、Monte Carlo、Policy Gradient、PPO、DQN 系列、A2C、DDPG、SAC、TD3 等实验。
- `papers/`：DQN 与策略梯度方向的经典论文 PDF 和中文解读。
